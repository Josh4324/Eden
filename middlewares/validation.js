...
exports.signUpValidationRules = () => {
    return [
        ...
        body("gender").notEmpty().isAlpha().trim().escape().withMessage("Please provide your gender"),
        body("status").notEmpty().isAlpha().trim().escape().withMessage("Please provide your marital status"),
        body("dateOfBirth").notEmpty().trim().escape().withMessage("Please provide your date of birth"),
